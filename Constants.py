from HttpClients.DictionaryHttpClient import DictionaryHttpClient
...
Dictionary_API = DictionaryHttpClient("https://cestina20.cz/")
...
commands = {
    ...
    "NWORD": {"client": Dictionary_API, "category": "pismeno/n/strana/", "karma": -5}
}
